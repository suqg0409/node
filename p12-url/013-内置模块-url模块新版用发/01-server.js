...
server.on("request",(req,res)=>{
    ...
    // let seachParams = myURL.searchParams
    // console.log(seachParams.get("a"))
...
// console.log("2222222222222",url.format(myURL,{unicode:true,auth:true,fragment:true,search:true}));
